...
export const translations = {
  en: {
    ...
    executive: {
      ...
      subtitle: 'A concise read on risk, cash flow, and guest readiness.',
      ...
      revenueAtRiskDesc: '{count} reservations need payment follow-up within 24 hours.',
      housekeepingBacklog: 'Housekeeping backlog',
      housekeepingBacklogDesc: '{count} cleaning tasks remain open.',
      arrivalPressure: 'Arrival pressure',
      arrivalPressureDesc: '{count} check-ins and {count2} departures today.',
      occupancyOutlook: 'Occupancy outlook',
      nextBestActions: 'Next best actions',
      actionCollect: 'Collect outstanding balances',
      actionCollectDesc: '{count} folios need follow-up before checkout.',
      actionPrep: 'Prepare arrivals',
      actionPrepDesc: '{count} check-ins land today.',
      actionClean: 'Clear turnover rooms',
      actionCleanDesc: '{count} cleaning tasks remain open.',
  ...
  es: {
    ...
    executive: {
      ...
      subtitle: 'Una lectura breve de riesgo, caja y preparación de huéspedes.',
      ...
      revenueAtRiskDesc: '{count} reservas requieren seguimiento de pago en 24 horas.',
      housekeepingBacklog: 'Pendiente de limpieza',
      housekeepingBacklogDesc: '{count} tareas de limpieza siguen abiertas.',
      arrivalPressure: 'Presión de llegadas',
      arrivalPressureDesc: '{count} check-ins y {count2} check-outs hoy.',
      occupancyOutlook: 'Perspectiva de ocupación',
      nextBestActions: 'Siguientes acciones',
      actionCollect: 'Cobrar saldos pendientes',
      actionCollectDesc: '{count} folios necesitan seguimiento antes del checkout.',
      actionPrep: 'Preparar llegadas',
      actionPrepDesc: '{count} check-ins llegan hoy.',
      actionClean: 'Liberar habitaciones',
      actionCleanDesc: '{count} tareas de limpieza siguen abiertas.',
